...
Route::prefix('stock')->name('stock.')->middleware('can:item.stock.index')->group(function () {
    Route::get('index', [StockController::class, 'index'])->name('index');
    Route::get('show/{id}', [StockController::class, 'show'])->name('show')->middleware('can:item.stock.show');
});

Route::prefix('stock-history')->name('stock-history.')->middleware('can:item.stock-history.index')->group(function () {
    Route::get('index', [StockHistoryController::class, 'index'])->name('index');
    Route::get('show/{id}', [StockHistoryController::class, 'show'])->name('show')->middleware('can:item.stock-history.show');
});
