...
{
    /**
     * @return LengthAwarePaginator<int, SalesOrderComponent>|Collection<int, SalesOrderComponent>
     */
    ...
    public function store(Request $request): array
    {
        ...
        return ['message' => trans('messages.success.store', ['target' => 'Sales Order Component'])];
    }
    ...
    public function update(Request $request): array
    {
        ...
        $salesOrderComponent = SalesOrderComponent::findOrFail($request->route('id'));
        $salesOrderComponent->sales_order_id = $request->input('sales_order_id');
        $salesOrderComponent->item_id = $request->input('item_id');
        $salesOrderComponent->quantity = $request->input('quantity');
        $salesOrderComponent->price = $request->input('price');
        ...
        return ['message' => trans('messages.success.update', ['target' => 'Sales Order Component'])];
    }
    ...
    public function delete(Request $request): array
    {
        ...
        return ['message' => trans('messages.success.delete', ['target' => 'Sales Order Component'])];
    }
    ...
    {
        /** @var SalesOrderComponent $salesOrderComponent */
        $salesOrderComponent = SalesOrderComponent::onlyTrashed()->findOrFail($request->route('id'));
        $salesOrderComponent->restore();

        return ['message' => trans('messages.success.restore', ['target' => 'Sales Order Component'])];
    }
    ...
    public function destroy(Request $request): array
    {
        ...
        return ['message' => trans('messages.success.destroy', ['target' => 'Sales Order Component'])];
    }
}
