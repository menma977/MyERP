...
use App\Models\User;
use Database\Factories\Vendors\VendorAccountPayableFactory;
use Eloquent;
 ...
 *
 * @method static VendorAccountPayableFactory factory($count = null, $state = [])
 ...
 * @mixin Eloquent
 */
#[UseResource(VendorAccountPayableResource::class)]
class VendorAccountPayable extends ApprovalAbstract
{
    /** @use HasFactory<\Database\Factories\Vendors\VendorAccountPayableFactory> */
