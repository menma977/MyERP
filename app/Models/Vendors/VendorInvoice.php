 ...
 * @property-read Collection<int, \App\Models\Vendors\VendorInvoiceComponent> $components
 ...
 * @method static Builder<static>|VendorInvoice withContributors()
 * @method static Builder<static>|VendorInvoice withTrashed(bool $withTrashed = true)
 * @method static Builder<static>|VendorInvoice withUsers()
...
{
    /** @use HasFactory<\Database\Factories\Vendors\VendorInvoiceFactory> */
