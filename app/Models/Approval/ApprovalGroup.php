 ...
 * @mixin Eloquent
 */
#[UseResource(ApprovalGroupResource::class)]
class ApprovalGroup extends ModelWithCompanyAbstract
{
    /** @use HasFactory<\Database\Factories\Approval\ApprovalGroupFactory> */
