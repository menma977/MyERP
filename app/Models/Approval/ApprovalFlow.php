 ...
 * @mixin Eloquent
 */
#[UseResource(ApprovalFlowResource::class)]
class ApprovalFlow extends ModelWithCompanyAbstract
{
    /** @use HasFactory<\Database\Factories\Approval\ApprovalFlowFactory> */
