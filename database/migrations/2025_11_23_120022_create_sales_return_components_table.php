...
return new class extends Migration {
	...
	{
		Schema::create('sales_return_components', function (Blueprint $table) {
			$table->ulid('id')->primary()->index();
			$table->foreignUlid('sales_return_id')->constrained('sales_returns')->cascadeOnDelete();
	...
	{
		Schema::dropIfExists('sales_return_components');
	}
};
